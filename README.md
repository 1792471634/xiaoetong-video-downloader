...
https://github.com/user-attachments/assets/手动抓包模式.mp4
...
5. **在软件中执行下载：** 拿到上述内容后，打开下载器，将获取的 `m3u8 地址` 和 `userId` 填入主界面对应的输入框（Title 标题处可自己重命名），点击 **Start** 即可。程序会自动跨越防盗链下载合并视频！
